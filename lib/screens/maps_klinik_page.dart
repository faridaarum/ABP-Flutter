...
class MapsKlinikPage extends StatefulWidget {
  static const String route = '/';

  const MapsKlinikPage({Key? key}) : super(key: key);

  @override
  State<MapsKlinikPage> createState() => _MapsKlinikPageState();
}

class _MapsKlinikPageState extends State<MapsKlinikPage> {
  @override
  void initState() {
    super.initState();
            ...
            builder: (context) => AlertDialog(
              ...
              content: ConstrainedBox(
                constraints: BoxConstraints(
                  maxWidth: width < 750 ? double.infinity : (width / (width < 1100 ? 1.5 : 2.5)),
                ),
                child: Column(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Alamat Klinik')),
      body: Padding(
        ...
        child: Column(
          children: [
            Flexible(
              child: FlutterMap(
                options: MapOptions(
                  center: LatLng(-6.973672, 107.631513),
                  zoom: 16,
                  ...
                  MarkerLayer(
                    markers: [
                      Marker(
                        width: 100,
                        height: 100,
                        point: LatLng(-6.973672, 107.631513),
